...
from fastpitch.layers import ConvReLUNorm
from fastpitch.utils import mask_from_lens
...
class TemporalPredictor(nn.Module):
    ...
    def __init__(self, input_size, filter_size, kernel_size, dropout, n_layers=2, n_predictions=1):
        ...
        self.layers = nn.Sequential(*[ConvReLUNorm(input_size if i == 0 else filter_size, filter_size, kernel_size=kernel_size, dropout=dropout) for i in range(n_layers)])
...
class FastPitch(nn.Module):
    def __init__(self):
        ...
        energy_conditioning='store_true'
