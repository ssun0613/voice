...
from ssun.FastPitchForman.utils.tools import get_mask_from_lengths
...
class FastPitchFormant(nn.Module):
    ...
    def forward(self, speakers, texts, src_lens, max_src_len, mels=None, mel_lens=None, max_mel_len=None, p_targets=None, d_targets=None, p_control=1.0, d_control=1.0):
        ...
        (h, p, p_predictions, log_d_predictions, d_rounded, mel_lens, mel_masks) = self.variance_adaptor(output, speaker_embedding, src_masks, mel_masks, max_mel_len, p_targets, d_targets, p_control, d_control)
