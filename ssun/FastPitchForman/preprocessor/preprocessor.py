...
import ssun.FastPitchForman.audio as Audio
...
class Preprocessor:
    ...
    def process_utterance(self, speaker, basename):
        ...
        if self.pitch_phoneme_averaging:
            ...
            interp_fn = interp1d(nonzero_ids, pitch[nonzero_ids], fill_value=(pitch[nonzero_ids[0]], pitch[nonzero_ids[-1]]), bounds_error=False)
        ...
        return ("|".join([basename, speaker, text, raw_text]),self.remove_outlier(pitch),mel_spectrogram.shape[1],)
