...
import hifigan
from ssun.FastPitchForman.model import FastPitchFormant, ScheduledOptim


def get_model(args, configs, device, train=False):
    (preprocess_config, model_config, train_config) = configs
    model = FastPitchFormant(preprocess_config, model_config).to(device)
...
def get_vocoder(config, device):
    ...
    if name == "MelGAN":
        ...
        if speaker == "LJSpeech":
            ...
            ckpt = torch.load("./hifigan/hifigan/generator_universal.pth.tar")
