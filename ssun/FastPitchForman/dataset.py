...
class Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {"id": basename, "speaker": speaker_id, "text": phone, "raw_text": raw_text, "mel": mel, "pitch": pitch, "duration": duration}
    ...
    def reprocess(self, data, idxs):
        ...
        return (ids, raw_texts, speakers, texts, text_lens, max(text_lens), mels, mel_lens, max(mel_lens), pitches, durations)
