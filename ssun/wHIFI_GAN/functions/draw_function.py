...
def tensorboard_draw(writer, mel_in, mel_out, recon_voice_loss, recon_pitch_loss, total_loss_g, total_loss_d, global_step, y_g_hat, sampling_rate):
    ...
    writer.add_audio('audio/voice_prediction', y_g_hat[0], sampling_rate)
